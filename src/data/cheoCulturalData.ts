/**
 * Complete Cultural Datasets for Chèo Heritage Platform
 * Location: src/data/cheoCulturalData.ts
...
// =========================================================================
// 1. R1 & HUB PAGES: KHÁM PHÁ HUB DATA (/kham-pha) & ALL HUBS
// =========================================================================
...
export const GIOI_THIEU_HUB_DATA: HubShowcaseData = {
  hubId: 'gioi-thieu',
  bannerTitle: 'Không Gian Giới Thiệu Bảo Tàng Chèo Số',
  bannerTagline: 'Cầu Nối Công Nghệ Số & Tâm Thức Di Sản Dân Gian',
  heroDescription: 'Tìm hiểu sứ mệnh bảo tồn nguyên trạng các làn điệu, phục trang và tích Chèo cổ, đồng thời mở ra không gian tương tác sống động đưa nghệ thuật dân tộc đến gần hơn với thế hệ trẻ.',
  featuredQuote: {
    verse: 'Đem chiếu chèo sân đình ngày xưa đặt lên không gian số của ngày mai.',
    author: 'Thông điệp dự án',
    context: 'Triết lý phụng sự di sản bằng công nghệ tương tác'
  },
  keyMetrics: [
    { value: '2+', unit: 'Năm', label: 'Hành trình điền dã', description: 'Ghi nhận tư liệu tại các làng chèo cổ Bắc Bộ' },
    { value: '1,200+', unit: 'Giờ', label: 'Tư liệu thu âm', description: 'Băng từ và đĩa than cổ phục chế kỹ thuật số' },
    { value: '30+', unit: 'Chuyên gia', label: 'Hội đồng cố vấn', description: 'Nghệ nhân Nhân dân, nhà nghiên cứu Hán Nôm' },
    { value: '100%', unit: 'Mở', label: 'Dữ liệu di sản', description: 'Phục vụ học thuật, nghiên cứu và công chúng' }
  ],
  exhibitionSubRooms: [
    {
      routePath: '/gioi-thieu/bao-tang-so-cheo',
      id: 'bao-tang-so-cheo',
      title: 'Bảo Tàng Số “Chèo”',
      badge: 'Tầm Nhìn Dự Án',
      highlightTag: 'Kiến trúc công nghệ số',
      summary: 'Ứng dụng công nghệ Web3D, âm thanh vòm binaural và hệ thống dữ liệu liên kết bảo tồn toàn vẹn di sản.',
      bulletHighlights: ['Công nghệ Web3D tương tác', 'Âm thanh vòm chuẩn phòng thu', 'Dữ liệu di sản mở'],
      actionLabel: 'Khám phá kiến trúc số'
    },
    {
      routePath: '/gioi-thieu/cau-chuyen-hinh-thanh',
      id: 'cau-chuyen-hinh-thanh',
      title: 'Câu Chuyện Hình Thành',
      badge: 'Ký Sự Điền Dã',
      highlightTag: 'Hành trình về cội nguồn',
      summary: 'Hơn 2 năm lăn lộn qua các làng chèo Khuốc, Yên Khánh, Nam Trực để ghi lại giọng hát của nghệ nhân lão thành.',
      bulletHighlights: ['Điền dã làng chèo cổ', 'Ký âm làn điệu nguy cơ mai một', 'Lời kể nghệ nhân lão thành'],
      actionLabel: 'Đọc ký sự điền dã'
    },
    {
      routePath: '/gioi-thieu/muc-tieu-va-y-nghia',
      id: 'muc-tieu-va-y-nghia',
      title: 'Mục Tiêu Và Ý Nghĩa',
      badge: 'Sứ Mệnh Di Sản',
      highlightTag: 'Ba mục tiêu chiến lược',
      summary: 'Bảo tồn nguyên trạng, phổ quát cộng đồng cho Gen Z & Alpha, và đưa Chèo vào mạng lưới bảo tàng quốc tế.',
      bulletHighlights: ['Bảo tồn nguyên trạng', 'Giáo dục di sản học đường', 'Giao lưu văn hóa quốc tế'],
      actionLabel: 'Xem mục tiêu chiến lược'
    },
    {
      routePath: '/gioi-thieu/doi-ngu-nhom-thuc-hien',
      id: 'doi-ngu-nhom-thuc-hien',
      title: 'Đội Ngũ Nhóm Thực Hiện',
      badge: 'Con Người Dự Án',
      highlightTag: 'Nghệ nhân & Kỹ sư',
      summary: 'Sự kết hợp giữa các Nghệ nhân Nhân dân gạo cội, nhà nghiên cứu văn hóa và đội ngũ kỹ sư công nghệ trẻ.',
      bulletHighlights: ['Hội đồng cố vấn nghệ thuật', 'Nghệ nhân truyền dạy', 'Kỹ sư công nghệ tương tác'],
      actionLabel: 'Gặp gỡ đội ngũ'
    }
  ]
}

export const SAN_KHAU_HUB_DATA: HubShowcaseData = {
  hubId: 'san-khau',
  bannerTitle: 'Đại Gian Trưng Bày Sân Khấu Biểu Diễn',
  bannerTagline: 'Bốn Trụ Cột Ước Lệ Toàn Bích Của Chiếu Chèo',
  heroDescription: 'Chiêm ngưỡng sự hòa quyện giữa mô thức nhân vật chuẩn mực, phục trang ngũ sắc Kinh Bắc, dàn nhạc Bát âm giòn giã và tứ đại kiệt tác tích Chèo lưu truyền qua bao thế hệ.',
  featuredQuote: {
    verse: 'Vào vai giọt lệ chứa chan / Bước ra chiếu diễn cả làng cười vang.',
    author: 'Ngạn ngữ nghệ nhân Chèo',
    context: 'Sức mạnh biến hóa thần kỳ của người nghệ sĩ trên manh chiếu chèo'
  },
  keyMetrics: [
    { value: '5', unit: 'Mẫu hình', label: 'Nhân vật ước lệ', description: 'Đào, Kép, Hề, Lão, Mụ phân minh chính tà' },
    { value: '5', unit: 'Sắc phục', label: 'Ngũ hành phục trang', description: 'Mớ ba mớ bảy, nón quai thao, yếm thắm' },
    { value: '6', unit: 'Cổ nhạc cụ', label: 'Dàn nhạc Bát âm', description: 'Trống đế cầm chầu, nhị nỉ non, nguyệt dẫn lối' },
    { value: '4', unit: 'Kiệt tác', label: 'Vở diễn kinh điển', description: 'Thị Kính, Kim Nhan, Lưu Bình, Nghêu Sò' }
  ],
  exhibitionSubRooms: [
    {
      routePath: '/kham-pha/san-khau/nhan-vat',
      id: 'nhan-vat',
      title: 'Hệ Thống Nhân Vật Ước Lệ',
      badge: '5 Mẫu Chuẩn',
      highlightTag: 'Đào - Kép - Hề - Lão - Mụ',
      summary: 'Quy ước phân vai nghiêm cẩn: diện mạo, bước đi, cử chỉ và tính cách bộc lộ ngay từ bước xưng danh đầu tiên.',
      bulletHighlights: ['Đào thương & Đào lẳng', 'Kép chính đĩnh đạc', 'Hề chèo trào phúng'],
      actionLabel: 'Khám phá 5 nhân vật'
    },
    {
      routePath: '/kham-pha/san-khau/trang-phuc',
      id: 'trang-phuc',
      title: 'Phục Trang & Phục Sức',
      badge: 'Sắc Màu Di Sản',
      highlightTag: 'Mớ ba mớ bảy & nón thao',
      summary: 'Khám phá ý nghĩa biểu tượng của áo tứ thân, dải yếm đào, nón ba tầm và quy chuẩn màu sắc phân định đẳng cấp.',
      bulletHighlights: ['Áo tứ thân mớ ba mớ bảy', 'Nón quai thao ba tầm', 'Màu sắc ngũ hành biểu trưng'],
      actionLabel: 'Chiêm ngưỡng trang phục'
    },
    {
      routePath: '/kham-pha/san-khau/am-thanh',
      id: 'am-thanh',
      title: 'Âm Thanh & Dàn Nhạc Cổ',
      badge: 'Linh Hồn Sân Khấu',
      highlightTag: 'Timeline 4 hồi & 6 nhạc cụ',
      summary: 'Trải nghiệm hành trình âm thanh một đêm diễn và tương tác với 6 nhạc cụ cốt lõi của dàn nhạc Chèo truyền thống.',
      bulletHighlights: ['Timeline 4 giai đoạn đêm chèo', 'Card 6 nhạc cụ độc lập', 'Thưởng thức làn điệu & thơ cổ'],
      actionLabel: 'Lắng nghe âm thanh'
    },
    {
      routePath: '/kham-pha/san-khau/tac-pham-tieu-bieu',
      id: 'tac-pham-tieu-bieu',
      title: 'Tác Phẩm Tiêu Biểu',
      badge: 'Tứ Đại Kiệt Tác',
      highlightTag: 'Pho sử thi sân khấu dân gian',
      summary: 'Khám phá chiều sâu nhân văn của Quan Âm Thị Kính, Kim Nhan, Lưu Bình Dương Lễ và tiếng cười trào lộng Nghêu Sò Ốc Hến.',
      bulletHighlights: ['Quan Âm Thị Kính', 'Xúy Vân giả dại', 'Lưu Bình Dương Lễ'],
      actionLabel: 'Xem các kiệt tác'
    }
  ]
}

export const TIEN_ICH_HUB_DATA: HubShowcaseData = {
  hubId: 'tien-ich',
  bannerTitle: 'Không Gian Tiện Ích & Cổng Dịch Vụ Di Sản',
  bannerTagline: 'Kết Nối Trực Tiếp Người Yêu Chèo Với Sàn Diễn Thực Tế',
  heroDescription: 'Cung cấp đầy đủ công cụ phục vụ nghiên cứu và trải nghiệm thực tế: tra cứu kho tư liệu cổ, định vị sơ đồ bảo tàng số, đặt vé xem diễn và hòm thư đóng góp ý kiến.',
  featuredQuote: {
    verse: 'Trăm nghe không bằng một thấy / Trăm thấy không bằng một lần đắm say cùng chiếu chèo.',
    author: 'Lời mời thưởng ngoạn',
    context: 'Kết nối trải nghiệm ảo với không gian nghệ thuật ngoài đời thực'
  },
  keyMetrics: [
    { value: '13', unit: 'Phòng', label: 'Sơ đồ bảo tàng', description: 'Định vị 3 tầng không gian triển lãm chuyên đề' },
    { value: '78', unit: 'RPM', label: 'Đĩa than cổ Dihavina', description: 'Bản thu âm master quý hiếm đầu thế kỷ XX' },
    { value: '4+', unit: 'Nhà hát', label: 'Kết nối lịch diễn', description: 'Nhà hát Chèo VN, Hà Nội, Ninh Bình, Thái Bình' },
    { value: '24/7', unit: 'Giờ', label: 'Hỗ trợ trực tuyến', description: 'Giải đáp thắc mắc và hướng dẫn trải nghiệm' }
  ],
  exhibitionSubRooms: [
    {
      routePath: '/tien-ich/tim-kiem',
      id: 'tim-kiem',
      title: 'Tìm Kiếm Di Sản',
      badge: 'Tra Cứu Thông Minh',
      highlightTag: 'Bộ lọc đa tiêu chí',
      summary: 'Tra cứu theo tên vở diễn, làn điệu, nhân vật, nghệ nhân hoặc các chủ đề nghiên cứu chuyên sâu.',
      bulletHighlights: ['Tìm theo làn điệu cổ', 'Tìm theo danh nhân nghệ sĩ', 'Tìm theo trích đoạn kinh điển'],
      actionLabel: 'Tra cứu ngay'
    },
    {
      routePath: '/tien-ich/ban-do-bao-tang',
      id: 'ban-do-bao-tang',
      title: 'Bản Đồ Bảo Tàng',
      badge: 'Sơ Đồ Phân Tầng',
      highlightTag: 'Quy hoạch 3 tầng 13 phòng',
      summary: 'Hệ thống định vị không gian đa tầng giúp khách tham quan dễ dàng lựa chọn lộ trình theo sở thích.',
      bulletHighlights: ['Tầng 1: Khởi nguồn & Điền dã', 'Tầng 2: Đại sảnh khám phá', 'Tầng 3: Lưu trữ & Quầy vé'],
      actionLabel: 'Mở sơ đồ bảo tàng'
    },
    {
      routePath: '/tien-ich/kho-tu-lieu',
      id: 'kho-tu-lieu',
      title: 'Kho Tư Liệu Di Sản',
      badge: 'Thư Viện Cổ',
      highlightTag: 'Đĩa than 78 vòng & chữ Nôm',
      summary: 'Kho lưu trữ di sản tập hợp các bản ghi âm đĩa than Dihavina và kịch bản Chèo cổ chép tay chữ Nôm.',
      bulletHighlights: ['Đĩa than 78 vòng Dihavina', 'Kịch bản Nôm Thị Kính 1875', 'Chuyên khảo GS. Trần Bảng'],
      actionLabel: 'Vào kho tư liệu'
    },
    {
      routePath: '/tien-ich/tham-quan-va-su-kien',
      id: 'tham-quan-va-su-kien',
      title: 'Tham Quan & Sự Kiện',
      badge: 'Cổng Biểu Diễn',
      highlightTag: 'Lịch diễn & Đặt vé',
      summary: 'Cập nhật lịch biểu diễn cuối tuần tại các nhà hát, sự kiện tọa đàm và cổng đặt vé trực tuyến mã QR.',
      bulletHighlights: ['Lịch biểu diễn toàn quốc', 'Đặt vé trực tuyến QR', 'Danh bạ các nhà hát Chèo'],
      actionLabel: 'Xem lịch diễn & đặt vé'
    }
  ]
}

export const HUB_SHOWCASE_MAP: Record<string, HubShowcaseData> = {
  'kham-pha': KHAM_PHA_HUB_DATA,
  'gioi-thieu': GIOI_THIEU_HUB_DATA,
  'san-khau': SAN_KHAU_HUB_DATA,
  'tien-ich': TIEN_ICH_HUB_DATA
}

export function getHubShowcaseData(idOrPath: string): HubShowcaseData | undefined {
  const cleanId = idOrPath.replace(/^\//, '').split('/')[0]
  return HUB_SHOWCASE_MAP[cleanId] || HUB_SHOWCASE_MAP[idOrPath]
}

// =========================================================================
// 2. R2: CHÈO HIỆN ĐẠI DETAILED DATA (/kham-pha/cheo-hien-dai)
// =========================================================================
  ...
  masterpieces: [
    {
      ...
      subTitle: 'Tập 1: Thề qua sông • Tập 2: Như những đỉnh núi • Tập 3: Tiếng sấm Tây Nguyên',
...
// =========================================================================
// 3. R3: ÂM THANH SÂN KHẤU & NHẠC CỤ (/kham-pha/san-khau/am-thanh)
// =========================================================================
  ...
  nightTimeline: [
    {
      ...
      timeInNight: '19:00 - 19:30 • Khai hội đầu làng',
    ...
    },
    {
      ...
      timeInNight: '19:30 - 20:15 • Nhập cuộc tích diễn',
    ...
    },
    {
      ...
      timeInNight: '20:15 - 21:30 • Trọng tâm cảm xúc',
    ...
    },
    {
      ...
      timeInNight: '21:30 - 22:30 • Hoan ca kết hội',
...
// =========================================================================
// 4. EXPANDED SCOPE: CROSS-MUSEUM DETAILED DATA
// =========================================================================
...
export const BACKSTAGE_ARTISTRY_DATA: BackstageArtistryData = {
  fourPillarsOfMastery: [
    ...
    },
    {
      ...
      explanation: 'Tay múa quạt phải uyển chuyển, bước chân chữ Đinh vững chãi, tà áo vạt đũi bay lượn theo từng nhịp trống đế tung hứng nhịp nhàng.',
...
export const CULTURAL_PHILOSOPHY_DATA: CulturalPhilosophyData = {
  humanisticPillars: [
    ...
    },
    {
      ...
      corePhilosophy: 'Triết lý dân gian: ở hiền gặp lành, kẻ gian tà dù có quyền thế cuối cùng cũng chịu quả báo trước dân làng.',
...
// Standalone convenience exports for direct contract consumption
export const HERITAGE_PILLARS: HeritagePillar[] = KHAM_PHA_HUB_DATA.pillars || []
export const CHEO_NIGHT_TIMELINE: CheoNightTimelinePhase[] = CHEO_AUDIO_COMPLETE_DATA.nightTimeline
export const CHEO_ORCHESTRA_INSTRUMENTS: CheoInstrumentCard[] = CHEO_AUDIO_COMPLETE_DATA.instrumentsCatalog
export const CHEO_CLASSIC_MELODIES: CheoMelodyLyric[] = CHEO_AUDIO_COMPLETE_DATA.classicMelodies
